...
The store creator — the same (set, get) => ({...}) function you'd pass to create normally.
Options object — configures storage key, backend, what to save, and lifecycle callbacks.
      products: initialProducts,
